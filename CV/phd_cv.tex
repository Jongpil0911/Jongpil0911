...
\begin{itemize}
    ...
    \begin{itemize}
        \item Developed the core algorithm for high accuracy and efficiency.
        \item Led the end-to-end development of core algorithm, achieving improvement in accuracy from \textbf{56\%} to \textbf{87\%} over previous methods.
        \item Designed and implemented a Graphic User Interface (GUI) to streamline user interaction.
        \item Created and packaged the necessary installer for seamless program distribution and development.
        \item Domestic patent pending (Japan) in collaboration with a private industry partner and \href{https://www.naro.go.jp/english/index.html}{National Agriculture and Food Research Organization (\textbf{NARO})}.
    \end{itemize}
\item Grant type: Joint Research with NARO and a private industry partner (Funded by a private industry partner under NDA, PI:Prof. M.-C. Lee) \\
% \hfill (Participation period) % Project link and duration
\end{itemize}
