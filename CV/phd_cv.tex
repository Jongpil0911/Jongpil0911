...
% Header
\begin{flushleft}
\href{https://scholar.google.com/citations?user=O-3pYeQAAAAJ&hl=en}{\textbf{\LARGE Jongpil JEONG} \href{https://orcid.org/0009-0003-5434-1601}{\includegraphics[width=9pt]{./orcid.pdf}}}\\[2pt] % Name
Master student \\ 
% Master of Engineering Student \\ 
Dept. of Creative Informatics at CSSE\\ 
...
% \href{https://jongpil0911.github.io}{Homepage}
\end{flushleft} 


\section*{EDUCATION}
\textbf{Kyushu Institute of Technology} \hfill Iizuka, Fukuoka, Japan\\
Master of Engineering in Dept. of Creative Informatics \hfill \textit{Apr. 2024 — Mar. 2026} \\
% Department of Creative Informatics (Computer Science and Networks) \hfill Cumulative GPA:\textbf{3.02/4.00} \\
Graduate School of Computer Science and Systems Engineering \hfill  GPA:\textbf{3.18/4.00} \\
Thesis:\textit{“Visibility Restoration under Harsh Conditions using Adaptive Removal via Mask for Scatter (ARMS)”} \\
...
Bachelor of Engineering in Dept. of Electronics Engineering \hfill \textit{Mar. 2018 — Feb. 2024} \\
College of Engineering \hfill GPA:\textbf{3.91/4.50} \\
...
Visibility Enhancement in Scattering Media and Low-Illumination Condition \\
% Deep Learning for signal processing. \\

% \begin{itemize}
%     % \item Three-dimensional imaging system
%     \item[] Image Signal Processing \& Computer Vision
...
%     \item[] Enhancement visibility via scattering media removal
%     % \item \textbf{Denoising / Deblurring Algorithm}
%     % \item Data science
%     \item[] Deep Learning for signal processing. \\
% \end{itemize} 
...
\begin{enumerate}[label={[\arabic*]}, start=1]
    ...
    ``Visibility Enhancement in Fire and Rescue Operation: ARMS Extension with Gaussian Estimation,''
    \textit{Electronics},
    vol. 15, 
    no. 3, 
    667,
    % pp. 72769--72777, 
    2026. \\
    DOI:\href{https://doi.org/10.3390/electronics15030667}{10.3390/electronics15030667} 
...
\begin{enumerate}[label={[\arabic*]}, start=1]
    ...
    Incheon, Korea. \\
    DOI: \href{https://doi.org/10.23919/ICCAS66577.2025.11301366}{10.23919/ICCAS66577.2025.11301366}
    % \hfill (In proceedings). \\
    ...
    Paris, France.  \\
    DOI: \href{https://doi.org/10.1117/12.3088544}{10.1117/12.3088544}. \\
    ...
    \textit{Proc. ICMV 2025}, (SPIE),
    Paris, France. \\
    DOI: \href{https://doi.org/10.1117/12.3088590}{10.1117/12.3088590}.
...
\normalfont{
    \begin{enumerate}[label={[\arabic*]}, start=1]
        ...
        \item 
        M.--C. Lee and \underbar{\textbf{J. Jeong}},                                                                \hfill {Dec. 09, 2024} \\
        ``Image processing apparatus, image processing method, and image processing program,'' \\
...
\begin{itemize}
    \item Researcher \hfill Mar. 2026 | Present
    \item Advisor: Prof. \href{https://scholar.google.com/citations?user=9sv1-5QAAAAJ&hl=en&oi=ao}{Min-Chul Lee}
\end{itemize}
...
\begin{itemize}
    ...
    % \end{itemize}
    \item Grant number: \href{https://kaken.nii.ac.jp/grant/KAKENHI-PROJECT-24K01120}{24K01120} (Funded by KAKEN, JSPS, PI:Prof. M.-C. Lee) %\hfill (Project: Apr. 2024--Mar. 2027)  % Project link and duration
\end{itemize}
...
\begin{itemize}
    ...
    % \end{itemize}
    \item Grant number: JPJ000255 (Funded by Fire and Disaster Management Agency of Japan, PI:Prof. M.-C. Lee) 
...
\begin{itemize}
    ...
    % \end{itemize}
    \item Grant number: \href{https://kaken.nii.ac.jp/en/grant/KAKENHI-PROJECT-23K19964/}{23K19964} (Funded by KAKEN, JSPS, PI:Dr. H.-W. Kim)    % Project link and duration 
\end{itemize}
...
\begin{itemize}
    ...
    % \begin{itemize}
    %     \item Developed the core algorithm for high accuracy and efficiency.
    %     \item Led the end-to-end development of image preprocessing systems, achieving improvement in accuracy from \textbf{56\%} to \textbf{up to 97\%} compared to previous methods.
    %     \item Designed and implemented a Graphic User Interface (GUI) to streamline user interaction.
    %     \item Created and packaged the necessary installer for seamless program distribution and development.
    %     \item Domestic patent pending (Japan) in collaboration with \href{https://www.hitachi-solutions-create.co.jp}{Hitachi Solutions Create, Ltd. (HSC)} and \href{https://www.naro.go.jp/english/index.html}{National Agriculture and Food Research Organization (NARO)}.
    % \end{itemize}
    \item Grant type: Joint Research with HSC and NARO (Funded by HSC, PI:Prof. M.-C. Lee) 
% \hfill (Participation period) % Project link and duration
% \item  Related Articles \href{https://www.kyutech.ac.jp/whats-new/press/entry-11919.html}{[1]}, \href{https://www.kyutech.ac.jp/archives/025/202601/press260122.pdf}{[2]} \\
    % \item  Related Article and Patent
    % \begin{itemize}
    %     \item Articles
    %     \begin{itemize}
    %         \item Joint Development of Technology by HSC, NARO, and Kyushu Institute of Technology (Kyutech) for Non-destructive Pre-hatching Sex Determination for Eggs on the 3 Day of Incubation \href{https://www.nikkei.com/article/DGXZRSP702132_S6A120C2000000/}{[Link]} \href{https://www.kyutech.ac.jp/archives/025/202601/press260122.pdf}{[pdf]} 
    %         \item AI Identifies Chicken Embryo Gender with 97\% Accuracy to Cut Costs: Hitachi Affiliate and Partners Developed New Technology \href{https://news.web.nhk/newsweb/na/na-k10015034661000}{[Link]} 
    %     \end{itemize}
    %     \item Patent
    %     \begin{itemize}
    %         \item ``Sex identification service provision system and sex identification service provision method'' (Japanses Patent Application No.2025--154965)
    %     \end{itemize}
    % \end{itemize}
...
\begin{itemize}
    \item \textit{Visiting Research Student} 
    \item Advisor: Prof. \href{https://orcid.org/0000-0003-2896-770X}{Myugnjin Cho}
\end{itemize}
...
\textbf{\href{https://leelab.csn.kyutech.ac.jp}{3D Optical Imaging System Lab.} at Kyushu Institute of Technology} \hfill Fukuoka, Japan
\begin{itemize}
    \item \textit{Short-Term Visiting Researcher} (Winter \& Summer ) \hfill Jan. |  Feb. \& Jul.  | Aug. 2023
    \item Advisor: Prof. \href{https://orcid.org/0000-0001-8469-0288}{Min-Chul Lee}
\end{itemize}
% \begin{itemize}
...
\begin{itemize}
    \item \textit{Undergraduate Research Intern} \hfill Sep. 2022 | Jul. 2023 
    \item Advisor: Prof. \href{https://orcid.org/0000-0001-6716-5799}{Bongsoon Kang}
\end{itemize}
...
\section*{SKILLS}
% \begin{itemize}
%     \item[Languages] Korean (Native), English (\href{https://github.com/user-attachments/assets/f578b432-f7a8-410e-851c-852e9ae55378}{OPIc IH}), Japanese (Intermediate)
%     \item[Programming] C/C++, Python, MATLAB
%     \item[Libraries] PyTorch, TensorFlow, OpenCV, Qt, Pandas, NumPy, SciPy, Plotly
%     \item[Tools / OS] \LaTeX, Digit Cam, Spinnaker SDK, Pylon SDK, Git, Blender \\
% \end{itemize}
...
\textbf{Programming}   & C/C++, Python, MATLAB, CUDA \\
% \textbf{Libraries}     & PyTorch, TensorFlow, OpenCV, Qt, Pandas, NumPy, SciPy, Plotly \\
\textbf{Tools / OS}    & \LaTeX, DigitCam, Spinnaker SDK, Pylon SDK, Git, Blender, Arduino, Raspberry Pi  \\ \\
% \textbf{Tools / OS}    & \LaTeX, DigitCam, Spinnaker SDK, Pylon SDK, Git, Blender, Arduino, Raspberry Pi, NVIDIA Jetson series, STM 32  \\ \\
% \textbf{Affiliations}    & IEEE Student Member, SPIE Student Member \\ \\
\end{tabularx}
...
\begin{itemize}
    ...
    \item \href{https://github.com/user-attachments/assets/583762df-f208-4216-b836-a6a1921ec34b}{IDEC SoC Design Course}
...
% KAIST
\paragraph{\large{\href{https://gsds.kaist.ac.kr}{Korea Advanced Institute of Science and Technology (KAIST)}}}  \hfill Seoul (Hybrid), Korea
\begin{itemize}
    % \item \href{}{AI in Biomedical Imaging - AI in Healthcare Technique}               \hfill 2025
...
\textit{Participant (Student Delegate)}  \hfill Jan. 2026 \\
...
\textit{Team leader} \hfill Sep. 2023 | Dec. 2023% Position and duration
% \begin{itemize}
...
\noindent
\large{\textbf{Military Service - Republic of Korea Army}} \hfill Haman, Gyeongsangnam-do, Korea \\
...
\begin{itemize}
    ...
    \item \href{https://github.com/user-attachments/assets/584d8f84-5bbe-4a71-9ae3-bda5ce40bd6f}{Award for Outstanding Army Warrior} \hfill 2020 
    ...
    % \item \href{https://github.com/user-attachments/assets/c5b564e8-6c7d-45dd-bae5-3c6d228cf3a5}{Award for Outstanding Army Warrior} 
\end{itemize}

% \section*{Military Service}
% \noindent
% \textbf{\large{Republic of Korea Army}} \hfill Haman, Gyeongsangnam-do, Korea \\
% \textit{Sergeant, Active Duty Soldier} \hfill Apr. 2019 | Nov. 2020
% \begin{itemize}
%     % \item \href{https://github.com/user-attachments/files/21983055/IMG_20250826_0002_NEW_0001.pdf}{AI in Biomedical Imaging - AI in Healthcare Technique}               \hfill 2025
%     \item \href{https://github.com/user-attachments/assets/584d8f84-5bbe-4a71-9ae3-bda5ce40bd6f}{Award for Outstanding Army Warrior} \hfill 2020 
