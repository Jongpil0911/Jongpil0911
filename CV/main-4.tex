...
\textbf{Tools / OS}    & Digit Cam, Spinnaker SDK, Pylon SDK, Git, Linux, Windows, macOS \\ \\
\end{tabularx}
...
\noindent
\textbf{\href{https://3cholab.wordpress.com/정보/}{Computational, Holographic and Optical signal processing Lab.}} \hfill Gyunggi-do, Korea\\ % Company name and location
